import type { SkinnedTextureAvailability } from '../domain/resolve-skinned-texture-target';

import { useStore } from '@nanostores/react';
import { isSkinnedLibraryModel } from '@/modules/import/domain/model-scene-kind';
import { $activeModel } from '@/modules/viewport/stores/model-store';
import { $selection } from '@/modules/viewport/stores/selection-store';
import { getSkinnedTextureAvailability } from '../domain/resolve-skinned-texture-target';
