...
11. Growth seams: textures (US-28); texture prep modal — crop / wrap / client bg-remove (US-39); further mesh starter kits stay content-only under `create/domain/kits/`; further skinned kits add a GLB under `public/kits/` + registry entry (US-33 pattern); soft auto-weights / weight paint deferred
