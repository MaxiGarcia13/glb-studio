...
- [ ] **Author Simple building recipe** — Floors / walls / roof from box (and plane if US-24 shipped); metres, grounded, named parts
...
- [ ] **No engine fork** — Diff is mostly recipe/registry files
